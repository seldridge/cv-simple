...
$for(education)$
  $it.school$ & $it.location$ & {\multirow{$it.degrees/length$}{*}{\shortstack[l]{$for(it.degrees)$ $if(it.degree)$ $it.degree$ $else$ \vphantom{foobar} $endif$ $sep$\\$endfor$}}} & {\multirow{$it.degrees/length$}{*}{\shortstack[l]{$for(it.degrees)$ $if(it.major)$ $it.major$ $else$ \vphantom{foobar} $endif$ $sep$\\$endfor$}}} & {\multirow{$it.degrees/length$}{*}{\shortstack[l]{$for(it.degrees)$ $if(it.year)$ $it.year$ $else$ \vphantom{foobar} $endif$ $sep$\\$endfor$}}} \\
$endfor$
\end{tabularx}
$endif$
...
\printbibliography[heading=none, resetnumbers=true, keyword={report}]
