...
\renewcommand\entry[7]{\href{https://github.com/#1/#2}{\texttt{#1/#2}} & #3 & #4 & #5 \ifthenelse{\equal{#5}{1}}{commit}{commits} \textcolor{Greens9p6}{\texttt{#6++}} \textcolor{Reds9p4}{\texttt{#7--}} \\\\}
\begin{longtabu} to \textwidth {llX[l]r} %% {llp{0.35\textwidth}r}
