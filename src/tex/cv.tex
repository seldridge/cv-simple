...
\begin{longtabu} to \textwidth {llXr}
  \entry{seldridge}{verilog}{Verilog}{Repository for basic (and not so basic) Verilog blocks with high re-use potential}{176}
  \entry{bu-icsg}{dana}{Scala}{Dynamically Allocated Neural Network Accelerator for the \riscv Rocket Microprocessor in Chisel}{113}
  \entry{seldridge}{rocket-rocc-examples}{C}{Tests for example Rocket Custom Coprocessors}{25}
  \entry{IBM}{hdl-tools}{Tcl}{Facilitates building open source tools for working with hardware description languages (HDLs)}{21}
  \entry{IBM}{rocc-software}{C}{C/Assembly macros for talking with Rocket Custom Coprocessors (RoCCs)}{19}
  \entry{IBM}{chiffre}{Scala}{A fault-injection framework using Chisel and FIRRTL}{13}
...
\begin{longtabu} to \textwidth {llX[l]r}
  \entry{freechipsproject}{firrtl}{Scala}{Flexible Intermediate Representation for RTL}{58}{8037}{2300}
  \entry{freechipsproject}{chisel3}{Scala}{Constructing Hardware in a Scala Embedded Language version 3}{41}{1714}{281}
  ...
  \entry{freechipsproject}{chisel-testers}{Scala}{Provides various testers for chisel users}{1}{8}{2}
