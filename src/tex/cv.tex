...
\begin{longtabu} to \textwidth {llXr}
  \entry{seldridge}{verilog}{Verilog}{Repository for basic (and not so basic) Verilog blocks with high re-use potential}{149}
  \entry{bu-icsg}{dana}{Scala}{Dynamically Allocated Neural Network Accelerator for the \riscv Rocket Microprocessor in Chisel}{91}
  \entry{IBM}{hdl-tools}{Tcl}{Facilitates building open source tools for working with hardware description languages (HDLs)}{20}
  \entry{seldridge}{rocket-rocc-examples}{C}{Tests for example Rocket Custom Coprocessors}{19}
  \entry{IBM}{rocc-software}{C}{C/Assembly macros for talking with Rocket Custom Coprocessors (RoCCs)}{14}
  \entry{IBM}{perfect-chisel}{Scala}{Chisel artifacts developed under IBM's involvement with the DARPA PERFECT program}{11}
  \entry{IBM}{chiffre}{Scala}{A fault-injection framework using Chisel and FIRRTL}{6}
...
\begin{longtabu} to \textwidth {llX[l]r}
  \entry{freechipsproject}{chisel3}{Scala}{Constructing Hardware in a Scala Embedded Language version 3}{29}{1316}{149}
  \entry{freechipsproject}{firrtl}{Scala}{Flexible Intermediate Representation for RTL}{28}{2534}{980}
  \entry{freechipsproject}{rocket-chip}{Scala}{Rocket Chip Generator}{25}{411}{198}
