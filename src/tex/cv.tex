...
\begin{longtabu} to \textwidth {llXr}
  ...
  \entry{ibm}{rocc-software}{C}{C/Assembly macros for talking with Rocket Custom Coprocessors (RoCCs)}{7}
...
\printbibliography[heading=none, resetnumbers=true, keyword={conference}, keyword={peer-reviewed}]

\subsubsection*{Peer Reviewed Journal Articles}
\printbibliography[heading=none, resetnumbers=true, keyword={journal}, keyword={peer-reviewed}]
