...
\begin{longtabu} to \textwidth {llXr}
  \entry{seldridge}{verilog}{Verilog}{Repository for basic (and not so basic) Verilog blocks with high re-use potential}{352}
  \entry{bu-icsg}{dana}{Scala}{Dynamically Allocated Neural Network Accelerator for the \riscv Rocket Microprocessor in Chisel~\cite{thesis:eldridge, DBLP:conf/IEEEpact/EldridgeWSAJ15, none:poster/RISCV/eldridge-2016, none:conf/BARC/Eldridge-2016, none:poster/DAC/eldridge-2016}}{173}
  ...
  \entry{IBM}{hdl-tools}{Tcl}{Facilitates building open source tools for working with hardware description languages (HDLs)}{43}
  \entry{IBM}{chiffre}{Scala}{A fault-injection framework using Chisel and FIRRTL~\cite{eldridge:2018:carrv, none:demo/CogArch/Roelke-2018, eldridge:2018:gomactech:velour}}{24}
  \entry{sifive}{chisel-circt}{Scala}{Library to compile Chisel circuits using CIRCT~\cite{none:conf/CCCC/Eldridge/2021}}{21}
...
\begin{longtabu} to \textwidth {llX[l]r}
  \entry{llvm}{circt}{\CC, MLIR}{Circuit IR Compilers and Tools~\cite{none:conf/CCCC/Eldridge/2021, none:conf/WOSET/Eldridge/2021}}{269}{24253}{9253}
  \entry{chipsalliance}{firrtl}{Scala}{Circuit Intermediate Representation and Compiler~\cite{none:conference/CCC/eldridge/2020/verilog-generation, none:workshop/CCC/eldridge-2018-annotations}}{198}{17459}{5619}
  \entry{chipsalliance}{chisel3}{Scala}{Scala-embedded hardware DSL~\cite{none:workshop/CCC/eldridge/2020/becoming-a-chisel-developer, none:workshop/CCC/eldridge-2018-libraries-intensive, eldridge:2018:modsim}}{156}{7990}{3406}
\end{longtabu}
