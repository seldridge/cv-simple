...
\newcommand\firstFooter{
  \lfoot{\href{mailto:schuyler.eldridge@ibm.com}{\textsc{schuyler.eldridge@ibm.com}}}
  \cfoot{\href{https://github.com/seldridge}{\textsc{seldridge@github}}}
  \rfoot{\href{tel:+19143821315}{\textsc{+1(914)382-1315}}}
...
\usepackage{datetime}
\yyyymmdddate
\newdateformat{yyyymmdate}{{\THEMONTH}/'\twodigit{\THEYEAR}}
...
\begin{longtabu}{lX[c]r}
  ...
  \entry{Graduate Technical Intern}{Server Memory Controller Validation}{Intel Corporation, Hudson, MA}{\formatdate{16}{05}{11}--\formatdate{09}{18}{11}}
...
\subsection*{Open Source Activities: \href{https://github.com/seldridge}{\texttt{seldridge@GitHub}}}
...
\begin{longtabu} to \textwidth {llXr}
  \entry{seldridge}{verilog}{Verilog}{Repository for basic (and not so basic) Verilog blocks with high re-use potential}{104}
  \entry{bu-icsg}{dana}{Scala}{Dynamically Allocated Neural Network Accelerator for the \riscv Rocket Microprocessor in Chisel}{46}
  \entry{seldridge}{rocket-rocc-examples}{C}{Tests for example Rocket Custom Coprocessors}{12}
  \entry{ibm}{hdl-tools}{Tcl}{Facilitates building open source tools for working with hardware description languages (HDLs)}{9}
  \entry{ibm}{rocc-software}{C}{C/Assembly macros for talking with Rocket Custom Coprocessors (RoCCs)}{6}
  \entry{ibm}{firrtl-mode}{Emacs Lisp}{Major mode for editing FIRRTL files in Emacs}{0}
  \entry{ibm}{chiffre}{Scala}{A fault-injection framework using Chisel and FIRRTL}{0}
\end{longtabu}
...
\begin{longtabu} to \textwidth {llX[l]r}
  \entry{freechipsproject}{rocket-chip}{Scala}{Rocket Chip Generator}{22}{333}{175}
  \entry{freechipsproject}{firrtl}{Scala}{Flexible Intermediate Representation for RTL}{11}{1516}{610}
  ...
  \entry{freechipsproject}{chisel3}{Scala}{Constructing Hardware in a Scala Embedded Language version 3}{2}{4}{2}
  \entry{github}{linguist}{Ruby}{Language Savant}{1}{8321}{0}
...
\begin{longtabu} to \textwidth {X[l]r}
  \entry{NASA Space Technology Research Fellowship}{\formatdate{01}{08}{13}--\formatdate{01}{08}{16}}
...
\begin{longtabu} to \textwidth {X[l]lllr}
  \entry{PERFECT: Efficient Resilience in Embedded Computing}{DARPA}{Staff}{\formatdate{29}{01}{2016}--present}
\end{longtabu}
...
\begin{longtabu} to \textwidth {Xr}
  \entry{Panelist}{Open Discussion -- Current State of \riscv Research}{1st Workshop on Computer Architecture Research with \riscv (CARRV '17)}{\formatdate{14}{10}{2017}}{Boston, MA}
...
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}lllp{0.4\textwidth}r}
