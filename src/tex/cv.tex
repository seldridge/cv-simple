...
\begin{longtabu} to \textwidth {llXr}
  \entry{seldridge}{verilog}{Verilog}{Repository for basic (and not so basic) Verilog blocks with high re-use potential}{125}
  \entry{bu-icsg}{dana}{Scala}{Dynamically Allocated Neural Network Accelerator for the \riscv Rocket Microprocessor in Chisel}{66}
  \entry{seldridge}{rocket-rocc-examples}{C}{Tests for example Rocket Custom Coprocessors}{16}
  \entry{IBM}{hdl-tools}{Tcl}{Facilitates building open source tools for working with hardware description languages (HDLs)}{16}
  \entry{IBM}{rocc-software}{C}{C/Assembly macros for talking with Rocket Custom Coprocessors (RoCCs)}{11}
