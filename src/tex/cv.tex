...
\begin{longtabu} to \textwidth {llXr}
  \entry{seldridge}{verilog}{Verilog}{Repository for basic (and not so basic) Verilog blocks with high re-use potential}{327}
  \entry{bu-icsg}{dana}{Scala}{Dynamically Allocated Neural Network Accelerator for the \riscv Rocket Microprocessor in Chisel~\cite{thesis:eldridge, DBLP:conf/IEEEpact/EldridgeWSAJ15, none:poster/RISCV/eldridge-2016, none:conf/BARC/Eldridge-2016, none:poster/DAC/eldridge-2016}}{170}
  \entry{seldridge}{rocket-rocc-examples}{C}{Tests for example Rocket Custom Coprocessors}{56}
  \entry{IBM}{rocc-software}{C}{C/Assembly macros for talking with Rocket Custom Coprocessors (RoCCs)}{45}
  \entry{IBM}{hdl-tools}{Tcl}{Facilitates building open source tools for working with hardware description languages (HDLs)}{40}
  ...
  \entry{IBM}{esp-chisel-accelerators}{Scala}{Embedded Scalable Platform accelerator socket~\cite{none:keynote/FOSDEM/eldridge/2020/esp-chisel-accelerators}}{15}
  \entry{sifive}{chisel-circt}{Scala}{Library to compile Chisel circuits using CIRCT~\cite{none:conf/CCCC/Eldridge/2021}}{15}
...
\begin{longtabu} to \textwidth {llX[l]r}
  \entry{chipsalliance}{firrtl}{Scala}{Circuit Intermediate Representation and Compiler~\cite{none:conference/CCC/eldridge/2020/verilog-generation, none:workshop/CCC/eldridge-2018-annotations}}{195}{17395}{5613}
  \entry{llvm}{circt}{\CC, MLIR}{Circuit IR Compilers and Tools~\cite{none:conf/CCCC/Eldridge/2021}}{181}{15907}{7389}
