...
\begin{longtabu} to \textwidth {llXr}
  \entry{seldridge}{verilog}{Verilog}{Repository for basic (and not so basic) Verilog blocks with high re-use potential}{314}
  \entry{bu-icsg}{dana}{Scala}{Dynamically Allocated Neural Network Accelerator for the \riscv Rocket Microprocessor in Chisel~\cite{thesis:eldridge, DBLP:conf/IEEEpact/EldridgeWSAJ15, none:poster/RISCV/eldridge-2016, none:conf/BARC/Eldridge-2016, none:poster/DAC/eldridge-2016}}{168}
  \entry{seldridge}{rocket-rocc-examples}{C}{Tests for example Rocket Custom Coprocessors}{54}
  \entry{IBM}{rocc-software}{C}{C/Assembly macros for talking with Rocket Custom Coprocessors (RoCCs)}{43}
  ...
  \entry{sifive}{chisel-circt}{Scala}{Library to compile Chisel circuits using CIRCT~\cite{none:conf/CCCC/Eldridge/2021}}{11}
...
\begin{longtabu} to \textwidth {llX[l]r}
  \entry{chipsalliance}{firrtl}{Scala}{Circuit Intermediate Representation and Compiler~\cite{none:conference/CCC/eldridge/2020/verilog-generation, none:workshop/CCC/eldridge-2018-annotations}}{189}{17350}{5594}
  \entry{chipsalliance}{chisel3}{Scala}{Scala-embedded hardware DSL~\cite{none:workshop/CCC/eldridge/2020/becoming-a-chisel-developer, none:workshop/CCC/eldridge-2018-libraries-intensive, eldridge:2018:modsim}}{155}{7985}{3404}
  \entry{llvm}{circt}{\CC, MLIR}{Circuit IR Compilers and Tools~\cite{none:conf/CCCC/Eldridge/2021}}{117}{11325}{4894}
\end{longtabu}
