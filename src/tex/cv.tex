...
\begin{longtabu} to \textwidth {llXr}
  \entry{seldridge}{verilog}{Verilog}{Repository for basic (and not so basic) Verilog blocks with high re-use potential}{262}
  \entry{bu-icsg}{dana}{Scala}{Dynamically Allocated Neural Network Accelerator for the \riscv Rocket Microprocessor in Chisel}{149}
  \entry{seldridge}{rocket-rocc-examples}{C}{Tests for example Rocket Custom Coprocessors}{44}
  \entry{IBM}{rocc-software}{C}{C/Assembly macros for talking with Rocket Custom Coprocessors (RoCCs)}{37}
  \entry{IBM}{hdl-tools}{Tcl}{Facilitates building open source tools for working with hardware description languages (HDLs)}{32}
  \entry{IBM}{chiffre}{Scala}{A fault-injection framework using Chisel and FIRRTL}{22}
  \entry{IBM}{perfect-chisel}{Scala}{Chisel artifacts developed under IBM's involvement with the DARPA PERFECT program}{21}
...
\begin{longtabu} to \textwidth {llX[l]r}
  \entry{freechipsproject}{firrtl}{Scala}{Flexible Intermediate Representation for RTL}{169}{16005}{5368}
  \entry{freechipsproject}{chisel3}{Scala}{Constructing Hardware in a Scala Embedded Language version 3}{145}{7187}{2938}
\end{longtabu}
