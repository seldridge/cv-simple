...
\begin{longtabu}{lX[c]r}
  \entry{SiFive}{Senior Staff Compiler Engineer}{San Mateo, CA}{\formatdate{14}{9}{2020}--present}
  ...
  \entry{Intel Corporation}{Graduate Technical Intern}{Hudson, MA}{\formatdate{16}{05}{2011}--\formatdate{18}{09}{2011}}
  \entry{Intel Corporation}{Graduate Technical Intern}{Hudson, MA}{\formatdate{20}{07}{2010}--\formatdate{27}{08}{2010}}
...
\subsection*{Grants}
\renewcommand\entry[4]{#1 & #2 & #3 & {\yyyymmdate #4}\\}
\begin{longtabu} to \textwidth {X[l]lllr}
  \entry{DSSoC: Domain Specific System on Chip}{DARPA}{Staff}{\formatdate{01}{08}{2018}--\formatdate{11}{09}{2020}}
...
\begin{longtabu} to \textwidth {llXr}
  ...
  \entry{bu-icsg}{dana}{Scala}{Dynamically Allocated Neural Network Accelerator for the \riscv Rocket Microprocessor in Chisel}{158}
  ...
  \entry{IBM}{chiffre}{Scala}{A fault-injection framework using Chisel and FIRRTL}{23}
...
\begin{longtabu} to \textwidth {llX[l]r}
  \entry{chipsalliance}{firrtl}{Scala}{Flexible Intermediate Representation for RTL}{182}{16817}{5516}
  \entry{chipsalliance}{chisel3}{Scala}{Constructing Hardware in a Scala Embedded Language version 3}{150}{7606}{3077}
\end{longtabu}
...
\renewcommand\entry[5]{\multirow{2}{*}{\shortstack[l]{#1: ``#2''\\\quad#3}} & \multirow{2}{*}{\shortstack[r]{{\yyyymmdate #4}\\#5}}\\\\}
